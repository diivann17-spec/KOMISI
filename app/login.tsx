...
const DEMO_USERS = [
  ...
  },
  {
    ...
    username: 'komisi1',
    password: 'password123',
    displayName: 'Komisi 1',
    roleLabel: 'Petugas Komisi 1',
    role: 'petugas',
    komisiAssigned: 'Komisi I',
    desc: 'Kelola agenda & anggota Komisi 1',
    icon: 'gavel',
    color: '#4F46E5',
  },
  {
    ...
    username: 'komisi2',
    password: 'password123',
    displayName: 'Komisi 2',
    roleLabel: 'Petugas Komisi 2',
    role: 'petugas',
    komisiAssigned: 'Komisi II',
    desc: 'Kelola agenda & anggota Komisi 2',
  ...
  },
  {
    ...
    username: 'komisi3',
    password: 'password123',
    displayName: 'Komisi 3',
    roleLabel: 'Petugas Komisi 3',
    role: 'petugas',
    komisiAssigned: 'Komisi III',
    desc: 'Kelola agenda & anggota Komisi 3',
    icon: 'construction',
    color: '#16A34A',
  },
  {
    ...
    username: 'komisi4',
    password: 'password123',
    displayName: 'Komisi 4',
    roleLabel: 'Petugas Komisi 4',
    role: 'petugas',
    komisiAssigned: 'Komisi IV',
    desc: 'Kelola agenda & anggota Komisi 4',
    icon: 'people',
    color: '#DB2777',
  },
  {
